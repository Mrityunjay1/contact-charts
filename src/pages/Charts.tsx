...
const Charts = (props: Props) => {
  ...
  const LineChartData1 = Object.keys(LineChartData.cases).map((date) => ({
    name: date,
    cases: LineChartData.cases[date],
    deaths: LineChartData.deaths[date],
    recoveries: LineChartData.recovered[date],
  }));
      ...
      <div className="p-16 md:p-8 lg:p-16 w-full h-[500px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={LineChartData1}>
            ...
            <Line type="monotone" dataKey="recoveries" stroke="#ff7300" />
          </LineChart>
        </ResponsiveContainer>
      </div>
